...
ENV DOCKER_IMAGE="rbd80/root.helixviper.org"
...
ENV TF_VAR_account_id="344457656106"
ENV TF_VAR_namespace="helix"
ENV TF_VAR_stage="root"

ENV TF_VAR_parent_domain_name="helixviper.org"
ENV TF_VAR_root_domain_name="root.helixviper.org"

ENV TF_VAR_prod_account_email="info+prod@helixviper.org"
ENV TF_VAR_prod_account_id="x"
ENV TF_VAR_prod_name_servers='["ns-1105.awsdns-10.org", "ns-1801.awsdns-33.co.uk", "ns-414.awsdns-51.com", "ns-835.awsdns-40.net"]'

ENV TF_VAR_staging_account_email="info+staging@helixviper.org"
ENV TF_VAR_staging_account_id="x"
ENV TF_VAR_staging_name_servers='["ns-1029.awsdns-00.org", "ns-1798.awsdns-32.co.uk", "ns-38.awsdns-04.com", "ns-776.awsdns-33.net"]'

ENV TF_VAR_audit_account_email="info+audit@helixviper.org"
ENV TF_VAR_audit_account_id="x"
ENV TF_VAR_audit_name_servers='["ns-1343.awsdns-39.org", "ns-2001.awsdns-58.co.uk", "ns-330.awsdns-41.com", "ns-881.awsdns-46.net"]'

ENV TF_VAR_dev_account_email="info+dev@chelixviper.org"
ENV TF_VAR_dev_account_id="x"
ENV TF_VAR_dev_name_servers='["ns-112.awsdns-14.com", "ns-1485.awsdns-57.org", "ns-1655.awsdns-14.co.uk", "ns-613.awsdns-12.net"]'

ENV TF_VAR_testing_account_email="info+testing@helixviper.org"
ENV TF_VAR_testing_account_id="344457656106"
